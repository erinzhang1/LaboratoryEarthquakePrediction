runacpath='D:\UCL\MSc_proj\original_data\p5198acData\run1\WF_'; % path where the .ac files live

% acoustic parameters
load('AcTimeVector_p5198'); % load in the acoustic time vector data;

acSettings = load('p5198_AE_run1.mat');              % load acoustic settings
...
writematrix(result, "variance_p5198_new.csv")